...
# Mapa de número de parâmetros por tipo de bloco
...
def _parsear_controlador(linhas: List[str], inicio: int,
    ...
    while i < len(linhas):
        ...
        # Parse da linha de bloco com reconhecimento de campos vazios (IMPORT/EXPORT)
        ...
        #
        # Estratégia: usar split() mas com reconhecimento de tokens especiais.
        ...
        # Blocos de interface têm um único lado preenchido —
        ...
        # Desambiguação parâmetros vs. limites
