...
def _executar_um(args: tuple) -> "subprocess.CompletedProcess":
...
class EnsaioAnatem:
    ...
    def configurar_template(self, **kwargs: object) -> "EnsaioAnatem":
    ...
    # ------------------------------------------------------------------
    # Análise de contingências automatizada (introduzida em v0.4.6, etapa 0.4)
    # ------------------------------------------------------------------
